...
def save_after_control(data_path, I1, I2, numControl, Y_pred, Y_phys_wc, Y_phys_nc, X_pred, center_B_save, target, seed, method):
    filename = f"data_eval_same_{seed}_{method}.npz"
